    ...
    <div className="advertisements-page">
      <div className="header">
        ...
        <div className="search-bar">
          ...
          <input id="pretraga" type="text" placeholder="Pretraži događaje..." />
        </div>
      ...
      <div className="container">
        <div className="filter">
          ...
          <div className="Vrsta">
            ...
            {["Koncert", "Izložba", "Predstava", "Putovanja", "Tulumi", "Kino", "Sport", "Prijevoz", "Ostalo"].map(
              (category, index) => (
                <li
                  key={category}
        ...
        <div className="cards-container">
          {filteredAds.length === 0 ? (
            <div className="no-events-message">Nema još takvih događaja... :(</div>
          ) : (
