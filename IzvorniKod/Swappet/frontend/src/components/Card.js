    ...
    const handlePurchase = async () => {
        ...
        try {
            if (ad.type === "0") {
                ...
                // Handle trade when ad.type is "1"
                if (selectedOption) {
    ...
    return (
        <div className="card">
            <div className="card-info">
                ...
                {<div className="tip1">Broj ulaznica: {availableTickets - count}</div> /*stavio sam da se prikazuje broj slobodnih ulaznica, ovo treba malo ljepše napraviti */}
